"""
Configuration management for Cortex Analytics Engine.
"""
...
class RAGConfig(BaseModel):
    ...
    collection_name: str = Field(default="cortex_analytics_insights", description="ChromaDB collection")
...
class Settings(BaseModel):
    ...
    project_root: Path = Field(default=Path("D:/CortexAnalytics"))
    data_dir: Path = Field(default=Path("D:/CortexAnalytics/data"))
    logs_dir: Path = Field(default=Path("D:/CortexAnalytics/logs"))
    cache_dir: Path = Field(default=Path("D:/CortexAnalytics/cache"))
